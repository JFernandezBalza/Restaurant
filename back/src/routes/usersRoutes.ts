...
usersRouter.post("/register", (req: Request<unknown, unknown, IUserRegisterDTO>, res: Response, next: NextFunction) => 
  userController.registerUsersController(req, res, next)
);

usersRouter.post("/login", (req: Request<unknown, unknown, IUserCredentialDTO>, res: Response, next: NextFunction) => 
